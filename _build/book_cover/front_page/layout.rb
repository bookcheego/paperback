RLayout::Container.new(fill_color:'clear', width:419.53, height:595.28) do
  ...
  container(fill_color:'clear',layout_length:5) do
    ...
    text("2022년에 책 만들기 14",font:'KoPubDotumPB', font_size: 40, text_alignment:'center', layout_length:8, font_color: 'black', fill_color: 'clear', text_fit_type:'adjust_box_height')
